...
[IfcGeoRefChecker](https://github.com/dd-bim/City2BIM/tree/master/IFCGeoRefCheckerGUI) is een open, op zichzelf staand Windows-gebaseerd softwareprogramma, ontwikkeld door Clemen en Görne (2019), bedoeld om de kwaliteit van georeferentie in Building Information Models (BIM) die in IFC-formaat zijn opgeslagen te evalueren en te verbeteren. Het werd geïntroduceerd in de publicatie “Level of Georeferencing (LoGeoRef) using IFC for BIM”, waarin de zogenoemde LoGeoRef-metriek wordt voorgesteld, een gestructureerde schaal die aangeeft hoe nauwkeurig een BIM-model is georeferentieerd, variërend van eenvoudige postadresinformatie (LoGeoRef10) tot volledige metadata van een coördinatenreferentiesysteem (LoGeoRef50). De tool controleert in hoeverre IFC-modellen voldoen aan de verschillende LoGeoRef-niveaus en geeft dit terug aan de gebruiker.

IfcGeoRefChecker werkt als een desktopapplicatie voor Windows, die georeferentiegegevens kan extraheren en analyseren uit IFC2x3-, IFC4- en IFC4.1-bestanden. De software controleert parameters zoals geografische coördinaten, translatiewaarden, rotatie ten opzichte van het ware noorden, hoogte en gebruikte coördinatenreferentiesystemen om te verifiëren of de ruimtelijke positionering en oriëntatie van het model correct zijn gedefinieerd. Gebruikers kunnen bovendien verschillende IFC-bestanden met elkaar vergelijken en foutieve parameters rechtstreeks aanpassen, ondersteund door een gedetailleerd protocol dat ontbrekende of inconsistente informatie weergeeft. 
De software wordt vergezeld door IfcGeoRefUpdater, een aanvullende toepassing waarmee correcties op IFC-bestanden kunnen worden toegepast op basis van de resultaten van de Checker. Deze tools te samen verbeteren de kwaliteit van georeferentie-informatie aanwezig in BIM modellen, waardoor deze beter in de ruimte (d.w.z. GIS-omgevingen) te plaatsen zijn.
