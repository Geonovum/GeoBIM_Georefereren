...
<a>Internal origin<br> is het vaste, niet-verplaatsbare nulpunt van het interne coördinatensysteem van software. Alle elementen in een 3D model worden uiteindelijk hiermee vastgelegd. Het wordt ook wel genoemd het  “absolute (0,0,0) nulpunt” van het model en vormt de basis voor het project base point en survey point.<br>
<br>
